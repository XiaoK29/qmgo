...
import (
	...
	"github.com/XiaoK29/qmgo/operator"
	"github.com/XiaoK29/qmgo/options"
)
...
func TestCollection_Update(t *testing.T) {
	...
	_, err = cli.UpdateOne(context.Background(), filter1, update1, opts)
	ast.NoError(err)
	...
	_, err = cli.UpdateOne(context.Background(), filter2, update2)
	...
	_, err = cli.UpdateOne(context.Background(), nil, update3)
	ast.Error(err)

	_, err = cli.UpdateOne(context.Background(), 1, update3)
	ast.Error(err)
	...
	_, err = cli.UpdateOne(context.Background(), filter4, nil)
	ast.Error(err)

	_, err = cli.UpdateOne(context.Background(), filter4, 1)
	ast.Error(err)
}
